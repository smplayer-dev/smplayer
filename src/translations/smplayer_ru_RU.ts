...
<context>
    ...
    <message>
        ...
        <translation type="obsolete">Если этот параметр включён, в заголовке окна будет отображаться информация из тегов. В противном случае будет показано только имя файла.</translation>
    </message>
    <message>
