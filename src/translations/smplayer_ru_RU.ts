...
<context>
    ...
    <message>
        ...
        <translation type="obsolete">Обход менеджера окон</translation>
    </message>
    <message>
        <source>If this option is checked, the control is displayed bypassing the window manager. Disable this option if the floating control doesn&apos;t work well with your window manager.</source>
        <translation type="obsolete">Если эта опция отмечена, панель управления будет отображаться в обход менеджера окон. Отключите эту опцию, если панель управления работает некорректно с вашим оконным менеджером.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="obsolete">Если эта опция отмечена, плавающая панель управления будет появляться также и в компактном режиме.&lt;b&gt; Внимание:&lt;/b&gt; плавающая панель не разрабатывалась для компактного режима и может работать некорректно.</translation>
    </message>
    <message>
