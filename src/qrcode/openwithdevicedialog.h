...
#ifndef OPENWITHDEVICEDIALOG_H
#define OPENWITHDEVICEDIALOG_H

#include "ui_openwithdevicedialog.h"

#include <QDialog>

class OpenWithDeviceDialog : public QDialog, public Ui::OpenWithDeviceDialog
{
	Q_OBJECT
