...
- Fixed HTTP header handling for extended URLs in m3u8 playlists
- Faster retrieval of media duration
- Fixed video aspect ratio override support
- Added support for additional network URI schemes (KDE integration)
- Forced the xcb backend on Linux to avoid display issues, even when QT_QPA_PLATFORM is already set
