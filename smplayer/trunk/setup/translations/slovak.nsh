...
LangString SMPLAYER_INSTALLER_PREV_ALL_USERS ${LANG_SLOVAK} "SMPlayer has been previously installed for all users.$\nPlease restart the installer with Administrator privileges."
...
LangString UNINSTALL_INSTALLED_ALL_USERS ${LANG_SLOVAK} "SMPlayer has been installed for all users.$\nPlease restart the uninstaller with Administrator privileges to remove it."
