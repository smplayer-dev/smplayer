...
LangString SMPLAYER_INSTALLER_PREV_ALL_USERS ${LANG_POLISH} "SMPlayer has been previously installed for all users.$\nPlease restart the installer with Administrator privileges."
...
; Uninstaller
LangString UNINSTALL_ABORTED ${LANG_POLISH} "Uninstall aborted by user."
LangString UNINSTALL_INSTALLED_ALL_USERS ${LANG_POLISH} "SMPlayer has been installed for all users.$\nPlease restart the uninstaller with Administrator privileges to remove it."
...
LangString APPLICATION_DESCRIPTION ${LANG_POLISH} "SMPlayer is a complete front-end for MPlayer, from basic features like playing videos, DVDs, VCDs to more advanced features like support for MPlayer filters, edl lists, and more."