...
<context>
    ...
    <message>
        ...
        <translation type="obsolete">请勾选此选项如果您希望添加一个目录的同时也添加子目录中的文件。否则只有当前目录的文件才会将加入。</translation>
    </message>
    <message>
        <location filename="../playlistpreferences.cpp" line="35"/>
        <source>Check this option to inquire the files to be added to the playlist for some info. That allows to show the title name (if available) and length of the files. Otherwise this info won&apos;t be available until the file is actually played. Beware: this option can be slow, specially if you add many files.</source>
        <translation type="obsolete">勾选此选项来对加到播放列表的文件获取一些信息。这将可以显示文件名(如果可用的话)和影片长度。否则这些信息只有当文件被播放时才能显示。小心: 这个选项可能很慢，尤其当您添加大量文件的时候。</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="obsolete">自动获取添加文件的信息(&amp;I)</translation>
    </message>
    <message>
        <location filename="../playlistpreferences.ui" line="46"/>
        <source>&amp;Save copy of playlist on exit</source>
        <translation type="obsolete">退出时保存播放列表(&amp;S)</translation>
    </message>
    <message>
        <location filename="../playlistpreferences.ui" line="25"/>
        <source>&amp;Play files from start</source>
        <translation type="obsolete">在头开始播放文件(&amp;P)</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <source>Check this option if you want that adding a directory will also add the files in subdirectories recursively. Otherwise only the files in the selected directory will be added.</source>
        <translation type="unfinished">请勾选此选项如果您希望添加一个目录的同时也添加子目录中的文件。否则只有当前目录的文件才会将加入。</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <source>Check this option to inquire the files to be added to the playlist for some info. That allows to show the title name (if available) and length of the files. Otherwise this info won&apos;t be available until the file is actually played. Beware: this option can be slow, specially if you add many files.</source>
        <translation type="unfinished">勾选此选项来对加到播放列表的文件获取一些信息。这将可以显示文件名(如果可用的话)和影片长度。否则这些信息只有当文件被播放时才能显示。小心: 这个选项可能很慢，尤其当您添加大量文件的时候。</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <source>&amp;Save copy of playlist on exit</source>
        <translation type="unfinished">退出时保存播放列表(&amp;S)</translation>
    </message>
</context>
<context>
