...
${LangFileString} Section_YTDL_Desc "Fornisce la possibilità di visualizzare video da YouTube."
...
${LangFileString} SMTube_Incompatible_Msg2 "Per favore aggiorna ad una nuova versione di SMTube."
