...
LangString UNINSTALL_ABORTED ${LANG_SLOVAK} "Uninstall aborted by user."
...
LangString APPLICATION_DESCRIPTION ${LANG_SLOVAK} "SMPlayer is a complete front-end for MPlayer, from basic features like playing videos, DVDs, VCDs to more advanced features like support for MPlayer filters, edl lists, and more."