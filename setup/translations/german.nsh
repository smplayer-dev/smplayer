...
LangString SMPLAYER_INSTALLER_PREV_ALL_USERS ${LANG_GERMAN} "SMPlayer wurde zuvor für alle Benutzer installiert.$\nBitte die Installation mit Administratorrechten starten."
...
LangString UNINSTALL_INSTALLED_ALL_USERS ${LANG_GERMAN} "SMPlayer wurde für alle Benutzer installiert.$\nBitte das Deinstallationsprogramm mit Administrator-Privilegien starten, um es zu entfernen."
